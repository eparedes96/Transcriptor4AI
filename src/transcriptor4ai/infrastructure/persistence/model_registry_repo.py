...
Acts as the central authority for AI model metadata. Orchestrates the discovery
lifecycle by merging build-time snapshots with live remote data from LiteLLM.
Implements canonical filtering and provider consolidation to ensure a clean UI
...
class ModelRegistryRepository(IModelRegistry):
    ...
    def __init__(self, fs_adapter: Optional[FileSystemAdapter] = None) -> None:
        ...
        self._cache_path = self._fs.get_pricing_cache_path()
    ...
    # ==========================================================================
    # DATA LOADING STRATEGIES (PRIVATE)
    # ==========================================================================
    ...
    def _normalize_and_filter(self, raw_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # 1. PROCESS: Internal Normalization and Consolidation
        ...
        # 2. PROCESS: Canonical Cleanup (Infrastructure De-duplication)
